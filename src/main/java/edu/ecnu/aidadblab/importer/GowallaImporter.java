...
public class GowallaImporter {

    public static String INPUT_DIR = GlobalConfig.getDatasetDir() + "/gowalla/";
    ...
    public void loadDataGraph(Graph dataGraph, List<JSONObject> supplyData) {
        List<String> data = this.plainTxtImporter.readLine("Gowalla_totalCheckins.txt");
